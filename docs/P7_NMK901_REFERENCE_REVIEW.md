...
(1 / 960), `caseback.glb` (2 / 2880), and `strap.glb` (11 / 696). Their
...
and `3E492D2BA8522D2813812A816FF88674B0A37C5DA85DBEB0C19DD1131D394DD2`.
Blender 5.2.1 validated presentation-polish pass 3 at 185 meshes / 31220
vertices. The deterministic top, front, side and three-quarter review renders
include the layered date display, dial signature, framed luminous bezel pip,
two strap keepers and a separate buckle frame, pin and tang.
