...
export const visualAssetRegistry: Record<string, VisualAssetDescriptor> = {
  ...
  , 'archetype-hands-diver': { assetId: 'archetype-hands-diver', category: 'hands', assetType: 'glb', assetPath: '/assets/3d/archetypes/hands-diver.glb', anchor: 'hand-stack', offset: [0, 0, 1.4], units: 'millimetres', upAxis: 'Y', referenceCaseDiameterMm: 42 }
  , 'archetype-hands-pilot': { assetId: 'archetype-hands-pilot', category: 'hands', assetType: 'glb', assetPath: '/assets/3d/archetypes/hands-pilot.glb', anchor: 'hand-stack', offset: [0, 0, 1.4], units: 'millimetres', upAxis: 'Y', referenceCaseDiameterMm: 42 }
  , 'archetype-hands-field': { assetId: 'archetype-hands-field', category: 'hands', assetType: 'glb', assetPath: '/assets/3d/archetypes/hands-field.glb', anchor: 'hand-stack', offset: [0, 0, 1.4], units: 'millimetres', upAxis: 'Y', referenceCaseDiameterMm: 42 }
  , 'archetype-hands-dress': { assetId: 'archetype-hands-dress', category: 'hands', assetType: 'glb', assetPath: '/assets/3d/archetypes/hands-dress.glb', anchor: 'hand-stack', offset: [0, 0, 1.4], units: 'millimetres', upAxis: 'Y', referenceCaseDiameterMm: 42 }
  , 'archetype-hands-chronograph': { assetId: 'archetype-hands-chronograph', category: 'hands', assetType: 'glb', assetPath: '/assets/3d/archetypes/hands-chronograph.glb', anchor: 'hand-stack', offset: [0, 0, 1.4], units: 'millimetres', upAxis: 'Y', referenceCaseDiameterMm: 42 }
  , 'archetype-hands-chronograph-needle': { assetId: 'archetype-hands-chronograph-needle', category: 'hands', assetType: 'glb', assetPath: '/assets/3d/archetypes/hands-chronograph-needle.glb', anchor: 'hand-stack', offset: [0, 0, 1.4], units: 'millimetres', upAxis: 'Y', referenceCaseDiameterMm: 42 }
  , 'archetype-hands-chronograph-baton': { assetId: 'archetype-hands-chronograph-baton', category: 'hands', assetType: 'glb', assetPath: '/assets/3d/archetypes/hands-chronograph-baton.glb', anchor: 'hand-stack', offset: [0, 0, 1.4], units: 'millimetres', upAxis: 'Y', referenceCaseDiameterMm: 42 }
  , 'archetype-hands-chronograph-syringe': { assetId: 'archetype-hands-chronograph-syringe', category: 'hands', assetType: 'glb', assetPath: '/assets/3d/archetypes/hands-chronograph-syringe.glb', anchor: 'hand-stack', offset: [0, 0, 1.4], units: 'millimetres', upAxis: 'Y', referenceCaseDiameterMm: 42 }
