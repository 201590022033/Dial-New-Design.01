...
export const visualAssetRegistry: Record<string, VisualAssetDescriptor> = {
  ...
  , 'dial-face-40mm-layout-v1': { assetId: 'dial-face-40mm-layout-v1', category: 'dial', assetType: 'glb', assetPath: '/assets/3d/dials/dial_face_40mm_layout_v1.glb', materialProfile: 'dial', anchor: 'dial-seat', offset: [0, 0, -1.4], referenceCaseDiameterMm: 40 }
  ...
  , 'archetype-hands-diver': { assetId: 'archetype-hands-diver', category: 'hands', assetType: 'glb', assetPath: '/assets/3d/archetypes/hands-diver.glb', anchor: 'watch-axis', offset: [0, 0, 4.25], units: 'millimetres', upAxis: 'Y', referenceCaseDiameterMm: 42 }
  , 'archetype-hands-pilot': { assetId: 'archetype-hands-pilot', category: 'hands', assetType: 'glb', assetPath: '/assets/3d/archetypes/hands-pilot.glb', anchor: 'watch-axis', offset: [0, 0, 4.25], units: 'millimetres', upAxis: 'Y', referenceCaseDiameterMm: 42 }
  , 'archetype-hands-field': { assetId: 'archetype-hands-field', category: 'hands', assetType: 'glb', assetPath: '/assets/3d/archetypes/hands-field.glb', anchor: 'watch-axis', offset: [0, 0, 4.25], units: 'millimetres', upAxis: 'Y', referenceCaseDiameterMm: 42 }
  , 'archetype-hands-dress': { assetId: 'archetype-hands-dress', category: 'hands', assetType: 'glb', assetPath: '/assets/3d/archetypes/hands-dress.glb', anchor: 'watch-axis', offset: [0, 0, 4.25], units: 'millimetres', upAxis: 'Y', referenceCaseDiameterMm: 42 }
  , 'archetype-hands-chronograph': { assetId: 'archetype-hands-chronograph', category: 'hands', assetType: 'glb', assetPath: '/assets/3d/archetypes/hands-chronograph.glb', anchor: 'watch-axis', offset: [0, 0, 4.25], units: 'millimetres', upAxis: 'Y', referenceCaseDiameterMm: 42 }
  , 'archetype-hands-chronograph-needle': { assetId: 'archetype-hands-chronograph-needle', category: 'hands', assetType: 'glb', assetPath: '/assets/3d/archetypes/hands-chronograph-needle.glb', anchor: 'watch-axis', offset: [0, 0, 4.25], units: 'millimetres', upAxis: 'Y', referenceCaseDiameterMm: 42 }
  , 'archetype-hands-chronograph-baton': { assetId: 'archetype-hands-chronograph-baton', category: 'hands', assetType: 'glb', assetPath: '/assets/3d/archetypes/hands-chronograph-baton.glb', anchor: 'watch-axis', offset: [0, 0, 4.25], units: 'millimetres', upAxis: 'Y', referenceCaseDiameterMm: 42 }
  , 'archetype-hands-chronograph-syringe': { assetId: 'archetype-hands-chronograph-syringe', category: 'hands', assetType: 'glb', assetPath: '/assets/3d/archetypes/hands-chronograph-syringe.glb', anchor: 'watch-axis', offset: [0, 0, 4.25], units: 'millimetres', upAxis: 'Y', referenceCaseDiameterMm: 42 }
